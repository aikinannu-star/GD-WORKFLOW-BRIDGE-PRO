...
class ApiClient {
     ...
     */
    async driftanalysisListDriftanalysis(params, config) {
     ...
     * @path /health
     */
    async healthList(params, config) {
     ...
     */
    async intelligenceListIntelligenceeffectiveness(params, config) {
     ...
     */
    async intelligenceListIntelligenceeffectivenessAcceptancerate(params, config) {
     ...
     */
    async intelligenceListIntelligenceeffectivenessAccuracy(params, config) {
     ...
     */
    async intelligenceListIntelligenceeffectivenessMttd(params, config) {
     ...
     */
    async intelligenceListIntelligenceeffectivenessMttr(params, config) {
     ...
     */
    async intelligenceListIntelligenceeffectivenessRecommendations(params, config) {
     ...
     */
    async intelligenceListIntelligencehealth(params, config) {
     ...
     */
    async intelligenceListIntelligencelearning(params, config) {
     ...
     */
    async intelligenceListIntelligencelearningAdoptiongaps(params, config) {
     ...
     */
    async intelligenceListIntelligencelearningEffectivenessscore(params, config) {
     ...
     */
    async intelligenceListIntelligencelearningPerformance(params, config) {
     ...
     */
    async intelligenceListIntelligencelearningRecurringissues(params, config) {
     ...
     */
    async intelligenceListIntelligencelearningTrends(params, config) {
     ...
     */
    async marketplaceCreateMarketplacePlugins(params, config) {
     ...
     */
    async marketplaceCreateMarketplacePluginsInstall(params, config) {
     ...
     */
    async marketplaceCreateMarketplacePluginsKeys(params, config) {
     ...
     */
    async marketplaceCreateMarketplacePluginsKeysActivate(params, config) {
     ...
     */
    async marketplaceCreateMarketplacePluginsKeysRevoke(params, config) {
     ...
     */
    async marketplaceCreateMarketplacePluginsPublish(params, config) {
     ...
     */
    async marketplaceCreateMarketplacePluginsRatings(params, config) {
     ...
     */
    async marketplaceCreateMarketplacePluginsUninstall(params, config) {
     ...
     */
    async marketplaceCreateMarketplacePluginsUnpublish(params, config) {
     ...
     */
    async marketplaceCreateMarketplacePluginsVersions(params, config) {
     ...
     */
    async marketplaceCreateMarketplacePluginsVersionsArtifact(params, config) {
     ...
     */
    async marketplaceCreateMarketplaceProducts(params, config) {
     ...
     */
    async marketplaceCreateMarketplaceProductsPurchase(params, config) {
     ...
     */
    async marketplaceCreateMarketplaceSnapshots(params, config) {
     ...
     */
    async marketplaceCreateMarketplaceTenantsRemediateActivatekeys(params, config) {
     ...
     */
    async marketplaceCreateMarketplaceTenantsRemediateInstallmissingdeps(params, config) {
     ...
     */
    async marketplaceCreateMarketplaceTenantsRemediatePreview(params, config) {
     ...
     */
    async marketplaceDeleteMarketplacePluginsKeys(params, config) {
     ...
     */
    async marketplaceGetMarketplacePlugins(params, config) {
     ...
     */
    async marketplaceGetMarketplacePluginsInstalls(params, config) {
     ...
     * @path /api/v1/marketplace/plugins/{pluginId}/keys/{keyId}
     */
    async marketplaceGetMarketplacePluginsKeys(params, config) {
     ...
     * @path /api/v1/marketplace/plugins/{pluginId}/ratings
     */
    async marketplaceGetMarketplacePluginsRatings(params, config) {
     ...
     */
    async marketplaceGetMarketplacePluginsVersions(params, config) {
     ...
     */
    async marketplaceGetMarketplacePluginsVersionsArtifact(params, config) {
     ...
     */
    async marketplaceGetMarketplaceProducts(params, config) {
     ...
     */
    async marketplaceGetMarketplaceTenants(params, config) {
     ...
     */
    async marketplaceGetMarketplaceTenantsTrends(params, config) {
     ...
     */
    async marketplaceListMarketplaceInstalls(params, config) {
     ...
     * @path /api/v1/marketplace/plugins
     */
    async marketplaceListMarketplacePlugins(params, config) {
     ...
     * @path /api/v1/marketplace/plugins/{pluginId}/keys
     */
    async marketplaceListMarketplacePluginsKeys(params, config) {
     ...
     * @path /api/v1/marketplace/plugins/{pluginId}/versions
     */
    async marketplaceListMarketplacePluginsVersions(params, config) {
     ...
     * @path /api/v1/marketplace/plugins/{pluginId}/versions/{version}/artifact
     */
    async marketplaceListMarketplacePluginsVersionsArtifact(params, config) {
     ...
     * @path /api/v1/marketplace/products
     */
    async marketplaceListMarketplaceProducts(params, config) {
     ...
     * @path /api/v1/marketplace/snapshots
     */
    async marketplaceListMarketplaceSnapshots(params, config) {
     ...
     */
    async marketplaceListMarketplaceTenants(params, config) {
     ...
     * @path /api/v1/marketplace/plugins/{pluginId}
     */
    async marketplaceUpdateMarketplacePlugins(params, config) {
     ...
     */
    async platformListMarketplacePlatformDashboard(params, config) {
     ...
     */
    async platformListMarketplacePlatformDriftsummary(params, config) {
     ...
     */
    async platformListMarketplacePlatformOverview(params, config) {
     ...
     */
    async platformListMarketplacePlatformRankings(params, config) {
     ...
     */
    async platformListMarketplacePlatformTenantsoverview(params, config) {
     ...
     */
    async platformListMarketplacePlatformTimeseries(params, config) {
     ...
     */
    async remediationCreateRemediationevents(params, config) {
     ...
     */
    async remediationCreateRemediationeventsResolve(params, config) {
     ...
     */
    async riskzonesListRiskzones(params, config) {
     ...
     */
    async riskzonesListRiskzonesClassify(params, config) {
     ...
     */
    async testingCreateMarketplaceTestScenario(params, config) {
